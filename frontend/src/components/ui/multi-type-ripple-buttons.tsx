  ...
  const dynamicGridHoverStyles = useMemo(() => {
    ...
    for (let r = 0; r < GRID_HOVER_NUM_ROWS; r++) {
      for (let c = 0; c < GRID_HOVER_NUM_COLS; c++) {
        ...
        if (variant === 'hover') {
          nthChildHoverRules += `.hover-variant-grid-cell:nth-child(${childIndex}):hover ~ .hover-variant-visual-ripple {
          ...
          nthChildHoverRules += `.hoverborder-variant-grid-cell:nth-child(${childIndex}):hover ~ .hoverborder-variant-visual-ripple {
            top: ${topPos}em; left: ${leftPos}em;
    ...
    if (variant === 'hover') {
      ...
      return `.hover-variant-visual-ripple {
      ...
      return `.hoverborder-variant-ripple-container {
